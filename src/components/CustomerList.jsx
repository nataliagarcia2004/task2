...
const CustomerDialog = ({ open, onClose, onSave, customer, title }) => {
  ...
  // Update form data when customer or dialog state changes
  useEffect(() => {
...
// PropTypes validation for CustomerDialog
...
// PropTypes validation for DeleteConfirmDialog
...
// Main component for CustomerList management
const CustomerList = () => {
  ...
  // Search handler for filtering customers
